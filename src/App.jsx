...
const DockNav = () => (
  <motion.div 
    ...
    className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-surface border border-border rounded-full px-6 py-3 flex items-center gap-6 shadow-2xl shadow-primary/20 backdrop-blur-md"
  >
...
const Hero = () => {
  ...
  return (
    <section id="home" className="h-screen w-full relative flex items-center justify-center overflow-hidden">
      ...
      {/* Hero Content */}
      <motion.div style={{ y: yText, opacity }} className="relative z-10 text-center pointer-events-none">
        <h1 className="text-6xl sm:text-8xl md:text-[10vw] font-black leading-none uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-white/10 filter drop-shadow-[0_0_30px_rgba(139,92,246,0.3)]">
          Anas <br /> Latheef
        </h1>
        <p className="mt-6 text-xl sm:text-2xl text-primary font-medium tracking-widest uppercase filter drop-shadow-[0_0_10px_rgba(57,255,20,0.5)]">
      ...
      <motion.div 
        style={{ opacity }}
        className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 text-text-muted"
      >
  ...
  <section id="about" className="py-24 relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div className="mb-20 max-w-3xl">
      ...
      <motion.p 
        ...
        viewport={{ once: true }}
        className="text-text-muted text-lg leading-relaxed border-l-2 border-primary/50 pl-6"
      >
    ...
    <div id="skills" className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
      <IridiumCard className="md:col-span-2 flex flex-col justify-between" glowColor="rgba(57, 255, 20, 0.3)">
        <div>
      ...
      <IridiumCard className="flex flex-col justify-between overflow-hidden">
        <div>
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-24 relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="mb-12">
        <h2 className="text-4xl font-bold mb-4">Systems <span className="text-primary filter drop-shadow-[0_0_10px_rgba(139,92,246,0.8)]">Deployed</span></h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((proj, i) => (
          <IridiumCard key={i} className="group p-0" glowColor="rgba(6, 182, 212, 0.4)">
            ...
            <div className="p-6 relative z-10">
              ...
              <a href="#" className="inline-flex items-center text-sm font-medium text-white hover:text-status-green transition-colors">
...
const Footer = () => (
  <footer id="contact" className="py-24 relative z-10 border-t border-border mt-24 overflow-hidden bg-surface">
    ...
    <div className="text-center max-w-2xl mx-auto space-y-8 px-4">
      <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter">Initiate <span className="text-transparent bg-clip-text bg-gradient-to-r from-status-green to-primary">Contact</span></h2>
      <p className="text-text-muted">Ready to synthesize logistics and artificial intelligence for your operations? Transmit a message to my secure terminal.</p>
      
      <div className="flex justify-center gap-4 pt-4">
        <Button variant="primary" onClick={() => window.open('https://docs.google.com/forms/u/0/d/e/1FAIpQLSf1ympkMUXgh4KR5ll1M7aBzLGDx3RIGP2Wwr80wPJjQpOSeg/viewform', '_blank')} className="bg-status-green text-black hover:bg-status-green/80 hover:text-black">
          <Mail className="mr-2 h-4 w-4" /> Transmit Message
        </Button>
      </div>

      <div className="flex justify-center gap-6 pt-12">
        <a href="https://github.com/anaslatheef369-coder" target="_blank" className="text-text-muted hover:text-primary transition-colors"><Code className="h-6 w-6" /></a>
        <a href="https://wa.me/971564878321" target="_blank" className="text-text-muted hover:text-status-green transition-colors"><MessageSquare className="h-6 w-6" /></a>
      </div>
    </div>
  </footer>
);
...
export default function App() {
  return (
    <div className="relative min-h-screen bg-canvas selection:bg-primary/30 selection:text-white">
      <CustomCursor />
      <DockNav />
      <Hero />
      <SkillsAndAbout />
