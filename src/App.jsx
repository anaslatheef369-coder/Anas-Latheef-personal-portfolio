...
const Hero = () => {
  return (
    <section id="home" className="min-h-[100svh] w-full relative overflow-hidden px-4 pt-20 pb-10">
      {/* Position Name and Heading to Top Right */}
      <div className="absolute top-20 md:top-32 right-6 md:right-16 z-10 text-right pointer-events-none flex flex-col items-end max-w-2xl">
        ...
        <motion.p 
          ...
          className="mt-4 text-xs sm:text-sm md:text-xl text-status-green font-medium tracking-widest uppercase drop-shadow-[0_0_8px_rgba(0,255,65,0.5)]"
        >
...
const SkillsAndAbout = () => (
  <section id="about" className="py-24 relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <div className="mb-16 md:mb-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      {/* Profile Image - Cleaned up green rings */}
      <motion.div 
    ...
    <div id="skills" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[250px]">
      <IridiumCard className="md:col-span-2 lg:col-span-2 flex flex-col justify-between" glowColor="rgba(0, 255, 65, 0.3)">
        <div>
      ...
      <IridiumCard className="flex flex-col justify-between" glowColor="rgba(255, 0, 60, 0.3)">
        <div>
      ...
      <IridiumCard className="flex flex-col justify-between" glowColor="rgba(0, 255, 65, 0.3)">
        <div>
      ...
      <IridiumCard className="flex flex-col justify-between md:col-span-2 lg:col-span-1" glowColor="rgba(255, 0, 60, 0.3)">
        <div>
  ...
  return (
    <section id="projects" className="py-24 relative z-10 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 flex justify-between items-end">
        <h2 className="text-3xl md:text-5xl font-display font-bold uppercase text-white">Systems <span className="text-status-red filter drop-shadow-[0_0_10px_rgba(255,0,60,0.8)]">Deployed</span></h2>
      ...
      >
        {projects.map((proj, i) => (
          <IridiumCard key={i} className="group p-0 flex flex-col w-[300px] md:w-[400px] shrink-0 snap-center" glowColor="rgba(255, 0, 60, 0.4)">
            ...
            <div className="p-6 relative z-10 flex-1 flex flex-col justify-between">
              ...
              <a href="#" className="inline-flex items-center text-sm font-medium text-status-green hover:text-white transition-colors mt-auto uppercase tracking-widest">
...
const Articles = () => {
  ...
  return (
    <section id="articles" className="py-24 relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="mb-12">
        <h2 className="text-3xl md:text-5xl font-display font-bold uppercase text-white">Latest <span className="text-status-green filter drop-shadow-[0_0_10px_rgba(0,255,65,0.8)]">Articles</span></h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {articles.map((art, i) => (
          <IridiumCard key={i} className="group cursor-pointer hover:-translate-y-2 transition-transform duration-300" glowColor="rgba(255, 255, 255, 0.2)">
            <span className="text-xs font-mono text-status-red mb-3 block uppercase tracking-widest">{art.cat}</span>
...
export default function App() {
  return (
    <div className="relative min-h-screen bg-canvas selection:bg-status-red/30 selection:text-white font-sans text-text-main pb-20 md:pb-0">
      ...
      {/* Global 3D Background - Persists across ALL sections */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <Canvas camera={{ position: [0, 0, 5] }}>
          <ambientLight intensity={0.5} />
          <directionalLight position={[10, 10, 5]} intensity={1.5} color="#FFFFFF" />
          <pointLight position={[-10, -10, -5]} intensity={3} color="#FF003C" />
